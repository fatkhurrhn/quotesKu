...
export default function Storythur() {
  ...
  useEffect(() => {
    const fetchQuotes = async () => {
      try {
        ...
        // Filter hanya yang author-nya "storythur" (case insensitive)
  ...
  const getDisplayMessage = () => {
    ...
    return `Total ${quotes.length} quotes dari Storythur`;
  };
      ...
      <div className="fixed top-0 left-0 w-full z-50 bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Cari quote dari Storythur..."
          ...
          <div className="space-y-3">
            {filteredQuotes.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-500">Tidak ada quote dari Storythur</p>
              </div>
            )}
          </div>
        )}
